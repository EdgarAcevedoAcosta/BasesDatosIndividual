...
public class ClienteDTO {
    ...
    public ClienteDTO(int idCliente, String nombres, String apellidoPaterno, String apellidoMaterno, Date nacimiento, int ciudad, String contrasena, String correo) {
